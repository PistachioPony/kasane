...
const PUZZLES = [
  ...
  },
  {
    ...
    facts: [
      ...
      { id: 'levi3',   fact: "The Type 3 Trucker first appeared in Levi's October 1961 catalog. It became the most iconic denim jacket silhouette in the world." },
    ],
  },
  {
    id: 'founded',
    ...
    facts: [
      ...
      { id: 'ironheart', fact: 'Shinichi Haraki founded Iron Heart in 2002 after 20 years in the denim industry, combining his expertise with his passion for Harley-Davidson motorcycles.' },
  ...
  },
  {
    ...
    items: [
      { id: 'natural',   label: 'Natural Indigo Vat Dyeing', sub: 'Ancient' },
    ...
    correctOrder: ['natural', 'synthetic', 'rope', 'slasher', 'garment', 'foam'],
    facts: [
      { id: 'natural',   fact: 'Natural indigo vat dyeing is ancient — the Indigofera plant was used in India thousands of years before denim existed.' },
